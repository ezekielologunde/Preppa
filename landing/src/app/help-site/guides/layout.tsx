...
/** Shared chrome for every guide article — centered prose column + back link. Lets
 * each guide page stay a bare <article className="prose"> with no layout boilerplate. */
