...
const PREPPER_META: Record<PrepperBadgeKey, BadgeMeta> = {
  first_order:   { label: 'First Order',    Icon: Sparkles,   color: '#f59e0b', bg: '#fef3c7', description: 'Received their first order' },
  ...
  five_star:     { label: '5-Star Chef',     Icon: Star,       color: '#f59e0b', bg: '#fffbeb', description: '4.8+ rating, 10+ reviews' },
  local_legend:  { label: 'Local Legend',    Icon: Trophy,     color: '#d97706', bg: '#fef3c7', description: '50+ unique customers' },
  protein_king:  { label: 'Protein King',    Icon: Zap,        color: '#ef4444', bg: '#fef2f2', description: 'High-protein specialist' },
...
const CUSTOMER_META: Record<CustomerBadgeKey, BadgeMeta> = {
  first_order:      { label: 'First Order',      Icon: Sparkles,    color: '#f59e0b', bg: '#fef3c7', description: 'Placed their first order' },
  ...
  macro_hunter:     { label: 'Macro Hunter',     Icon: Zap,         color: '#ef4444', bg: '#fef2f2', description: 'Orders high-protein meals' },
